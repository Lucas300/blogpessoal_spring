...
public class UsuarioControllerTest {
	...
	@Autowired
	private UsuarioService usuarioService; //um objeto da Classe UsuarioService para persistir os objetos no Banco de dados de testes com a senha criptografada.
	...
	public void deveCriarUmUsuario() {
		...
		ResponseEntity<Usuario> corpoResposta = testRestTemplate
			.exchange("/usuarios/cadastrar", HttpMethod.POST, corpoRequisicao, Usuario.class);//exchange é tipo o send do insomnia
